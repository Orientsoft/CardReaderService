...
{
    public class HailiCardInfo : CardInfo
    {
        private short com;
        private long baud;
        private short klx;
    ...
    public class HailiOrderInfo : OrderInfo
    {
        private short com;
        private long baud;
        private short klx;
    ...
    public class HailiWatchInfo : WatchInfo
    {
        private short com;
        private long baud;
        private short klx;
    ...
    public class HailiMetaInfo : CardMetaInfo
    {
        private short com;
        private long baud;
        private short klx;
    ...
    public class HailiCardReader : CardReaderAdpator
    {
        // DLL imports
        ...
        [DllImportAttribute("HLICCard.dll", EntryPoint = "makeInitCard", CallingConvention = CallingConvention.StdCall)]
        ...
        {
            HailiMetaInfo meta = (HailiMetaInfo)metaInfo;
        ...
        public CardReaderResponseCode MakeInitCard(HailiWatchInfo watchInfo)
        {
