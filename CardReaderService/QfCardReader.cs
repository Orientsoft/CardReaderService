...
{
    public class QfCardInfo : CardInfo
    {
        private short com;
        private long baud;
        private short klx;
    ...
    public class QfOrderInfo : OrderInfo
    {
        private short com;
        private long baud;
        private short klx;
    ...
    public class QfWatchInfo : WatchInfo
    {
        private short com;
        private long baud;
        private short klx;
    ...
    public class QfMetaInfo : CardMetaInfo
    {
        private short com;
        private long baud;
        private short klx;
    ...
    public class QfCardReader : CardReaderAdpator
    {
        // DLL imports
        [DllImportAttribute("QFIC_IGasMeter.dll", EntryPoint = "ReadGasCard", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImportAttribute("QFIC_IGasMeter.dll", EntryPoint = "WriteNewCard", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImportAttribute("QFIC_IGasMeter.dll", EntryPoint = "WriteGasCard", CallingConvention = CallingConvention.StdCall)]
        private static extern int WriteGasCard(short com, Int32 baud, short klx, byte[] kh, short ql, short cs, Int32 ljgql);

        [DllImportAttribute("QFIC_IGasMeter.dll", EntryPoint = "FormatGasCard", CallingConvention = CallingConvention.StdCall)]
        private static extern int FormatGasCard(short com, Int32 baud);

        [DllImportAttribute("QFIC_IGasMeter.dll", EntryPoint = "CheckGasCard", CallingConvention = CallingConvention.StdCall)]
        private static extern int CheckGasCard(short com, Int32 baud);

        [DllImportAttribute("QFIC_IGasMeter.dll", EntryPoint = "makeInitCard", CallingConvention = CallingConvention.StdCall)]
